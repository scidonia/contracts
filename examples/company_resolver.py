...
@pre_description("Text must be a non-empty string and database must be a list of valid company records with 'id', 'name', and 'url' fields")
@post_description("Returns a list of company records that were found in the text, preserving database structure with id, name, and url")
def resolve_company_names(text: str, company_database: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    """
